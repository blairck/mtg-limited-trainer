...
valuesToPrice = {"Floodfarm Verge (W/U)": (14, 850),
...
for i in range(1, 11):
    ...
    for item in combinations:
        ...
        combinationCost = reduce(lambda x, y: x+y, (valuesToPrice[i][1] for i in item))
        combinationScore = reduce(lambda x, y: x+y, (valuesToPrice[i][0] for i in item))
